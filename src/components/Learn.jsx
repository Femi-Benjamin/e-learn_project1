...
export default function Learn() {
  return (
    <div className='bg-[#BDEAFF] h-[924px]  mt-[182px]'>
        <div className='flex'>
            <div>
        ...
        <div className='flex justify-between'>
            ...
            <div className="">
                <video className='rounded-tl-[20px] rounded-tr-[20px] rounded-bl-[20px] rounded-br-[20px] border-[3px] border-white mr-[101px] mt-[90px]' autoPlay loop muted controls  src="https://player.vimeo.com/external/517730351.sd.mp4?s=9a026f7d34313485a304232cd8eaf91c9072f997&profile_id=164&oauth2_token_id=57447761"></video>
            </div>
        </div>
    </div>
  )
