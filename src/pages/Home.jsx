...
export const Home = () => {
  return (
    <div className="bg-[#EFF7FF] h-[1500px] w-auto">
        <HomeNav/> 
        <img className='absolute w-[318px] h-[318px] left-2 top-[100px]' src={imgi} alt="" />
        {/* <img className='relative w-[654px] h-[654px] left-[900px] top-[89px]' src={shadow} alt="" /> */}
        <div className='flex'>
